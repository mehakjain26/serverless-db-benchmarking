...
def transform_route(r, tid):
    ...
    return {
        ...
        "route_short_name": r.get("route_short_name") or r.get("short_name") or "",
        "route_long_name": r.get("route_long_name") or r.get("long_name") or "",
...
def transform_trip(r, tid):
    ...
    return {
        ...
        "headsign": r.get("trip_headsign") or r.get("headsign") or "",
        # This MUST exist for GSI: gsi_trip
