...
# --- CREDENTIALS (derived from db_config.py & environment) ---
import os
from database_clients.db_config import CLOUDANT

URL = os.getenv("CLOUDANT_URL", CLOUDANT["url"])
APIKEY = os.getenv("CLOUDANT_APIKEY", CLOUDANT["apikey"])
DB_NAME = os.getenv("CLOUDANT_DB", CLOUDANT["db"])
