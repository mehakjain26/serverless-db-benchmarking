"""
PostgreSQL Query Adapter Module (server/req_sql.py)

Implements parameterized SQL query access patterns (point_read, large_scan, next_departures,
trips_per_route, bulk_update_departures, triple_agg) for PostgreSQL & Neon database targets.
"""
