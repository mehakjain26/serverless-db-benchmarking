"""
Amazon DynamoDB Adapter Module (server/req_dynamodb.py)

Maps benchmark requests to Amazon DynamoDB key-value single-table queries.
"""

import time
from typing import Any, List, Tuple

from adapters.dynamodb.query_dynamodb import (
...
from core.req_gen import Request, RequestType
