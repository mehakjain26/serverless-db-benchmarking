"""
MongoDB Atlas Adapter Module (server/req_mongo.py)

Implements document query access patterns (point_read, large_scan, next_departures,
trips_per_route, bulk_update_departures, triple_agg) for MongoDB Atlas.
"""
